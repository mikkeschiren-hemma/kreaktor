...
print views_embed_view('Nodtyp_ref','block_1',$node->content['field_blogg']['field']['items'][0]['#item']['nid']);
?>
</div>
...
print views_embed_view('Titel_ref','block_1',$node->content['field_blogg']['field']['items'][0]['#item']['nid']);
?>
</h1>
...
$block = module_invoke('block', 'block' , 'view', 13, $node->content['field_blogg']['field']['items'][0]['#item']['nid']); 
print $block['content']; 
