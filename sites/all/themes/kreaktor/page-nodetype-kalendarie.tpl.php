...
<!--
<?php
echo format_date('1239645600', $type = 'custom', $format = 'l d F k\l. H:i', $timezone = NULL, $langcode = NULL);
?>
-->
  <!--[if IE 8]>
                      ...
                      <div id="content-group-inner" class="content-group-inner inner">
                        ...
                        <div id="content-region" class="content-region row nested">
                          <div id="content-region-inner" class="content-region-inner inner">
                            ...
                            <div id="content-inner" class="content-inner block kort">

<div class="nodtyp">

<?php print views_embed_view('Titel_ref','block_3',$node->content['field_kalendariumref']['field']['items'][0]['#item']['nid']);?>
</div>


                              <div id="content-inner-inner" class="content-inner-inner inner">
                        
                                <h1 class="title"><?php print views_embed_view('Titel_ref','block_1',$node->content['field_kalendariumref']['field']['items'][0]['#item']['nid']);?></h1>
                                 <div class="addtoany">
                                 <p> <a class="a2a_dd" href="http://www.addtoany.com/share_save">
    <img src="http://static.addtoany.com/buttons/share_save_171_16.png" width="171" height="16" border="0" alt="Dela"/>
</a>
</p>
...
<?php
$GLOBALS['nidnum'] = $node->content['field_blogg']['field']['items'][0]['#item']['nid'];



$block = module_invoke('block', 'block' , 'view', 14, $node->content['field_kalendariumref']['field']['items'][0]['#item']['nid']); 
print $block['content']; 
