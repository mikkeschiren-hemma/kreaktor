...
<?php
print views_embed_view('Nodtyp_ref','block_1',$_GET['grundnod']);
?>
</div>
...
print views_embed_view('Titel_ref','block_1',$_GET['grundnod']);
?>
</h1>
 <div class="addtoany">
...
?>
                                ...
                                <?php endif; ?>
<?php
$inlagg = views_embed_view('bloggposter_ref','panel_pane_1',$_GET['grundnod']);


/* ful hack */
if(strstr($inlagg,'view-empty'))
{ 
print $inlagg;
}
